...
use Database\Seeders\Tenant\NewPermissionSeed;
...
use Modules\HotelBooking\Database\Seeders\HotelBookingRolePermissionSeed;
use Modules\Knowledgebase\Database\Seeders\knowledgeRolePermissionSeed;
...
class GeneralSettingsController extends Controller
{
    ...
    public function update_third_party_script_settings(Request $request)
    {
        ...
        update_static_option('site_google_captcha_v2_site_key', $request->site_google_captcha_v2_site_key);
        update_static_option('site_google_captcha_v2_secret_key', $request->site_google_captcha_v2_secret_key);
    ...
    public function update_database_upgrade(Request $request){
        ...
        //store new permission into all tenants...
        Tenant::latest()->chunk(50,function ($tenans)
        {
            foreach ($tenans as $tenant){
                try {
                    Artisan::call('tenants:seed', ['--class' => NewPermissionSeed::class,'--tenants'=>$tenant->id,'--force' => true]);
                }catch (\Exception $e){
                    //if issue is related to the mysql database engine,
                }
            }
        ...
        Tenant::latest()->chunk(50,function ($tenans)
        {
            foreach ($tenans as $tenant){
                try {
                    ...
                    {
                        Artisan::call('tenants:seed', ['--class' => HotelBookingRolePermissionSeed::class,'--tenants'=>$tenant->id,'--force' => true]);
                    }
        ...
        //todo run a query to get all the tenant then run migrate one by one...
        Tenant::latest()->chunk(20,function ($tenans)
        {
            foreach ($tenans as $tenant){
                try {
                    if(moduleExists("Knowledgebase"))
                    {
                        Artisan::call('tenants:seed', ['--class' => knowledgeRolePermissionSeed::class,'--tenants'=>$tenant->id,'--force' => true]);
                    }
                }catch (\Exception $e){
                     //Doing nothing,
                }
  ...
  public function update_sitemap_settings(Request $request)
    ...
    private function all_themes_colors_fields() : array
    {
        ...
        $support_ticket_color_fields = [
            'support-ticketing_main_color_one' => 'nullable|string|max:191',
            'support-ticketing_main_color_one_rgb' => 'nullable|string|max:191',
            'support-ticketing_main_color_two' => 'nullable|string|max:191',
            'support-ticketing_main_color_two_rba' => 'nullable|string|max:191',
            'support-ticketing_heading_color' => 'nullable|string|max:191',
            'support-ticketing_heading_color_rgb' => 'nullable|string|max:191',
            'support-ticketing_heading_color_two' => 'nullable|string|max:191',
            'support-ticketing_btn_color_one' => 'nullable|string|max:191',
            'support-ticketing_btn_color_two' => 'nullable|string|max:191',
            'support-ticketing_section_bg_one' => 'nullable|string|max:191',
            'support-ticketing_scroll_bar_bg' => 'nullable|string|max:191',
            'support-ticketing_scroll_bar_color' => 'nullable|string|max:191',
            'support-ticketing_paragraph_color' => 'nullable|string|max:191',
            'support-ticketing_paragraph_color_two' => 'nullable|string|max:191',
        ];
        ...
        $software_color_fields = [
            'software-business_main_color_one' => 'nullable|string',
            'software-business_main_color_one_rgb' => 'nullable|string',
            'software-business_secondary_color'=> 'nullable',
            'software-business_secondary_color_rgb' => 'nullable',
            'software-business_section_bg' => 'nullable',
            'software-business_section_bg_secondary' => 'nullable',
            'software-business_section_bg_2' => 'nullable',
            'software-business_section_bg_3' => 'nullable',
            'software-business_white' => 'nullable',
            'software-business_white_rgb' => 'nullable',
            'software-business_black' => 'nullable',
            'software-business_black_rgb'=> 'nullable|string|max:191',
            'software-business_border_color'=> 'nullable|string|max:191',
            'software-business_border_color_two'=> 'nullable|string|max:191',
            'software-business_success_color'=> 'nullable|string|max:191',
            'software-business_heading_color'=> 'nullable|string|max:191',
            'software-business_body_color'=> 'nullable|string|max:191',
            'software-business_paragraph_color'=> 'nullable|string|max:191',
            'software-business_paragraph_color_two'=> 'nullable|string|max:191',
            'software-business_light_color'=> 'nullable|string|max:191',
            'software-business_review_color'=> 'nullable|string|max:191',
        ];

        $barber_color_fields = [
            'barber-shop_main_color_one' => 'nullable|string',
            'barber-shop_main_color_one_rgb' => 'nullable|string',
            'barber-shop_secondary_color'=> 'nullable',
            'barber-shop_secondary_color_rgb' => 'nullable',
            'barber-shop_section_bg' => 'nullable',
            'barber-shop_section_bg_main' => 'nullable',
            'barber-shop_section_bg_2' => 'nullable',
            'barber-shop_section_bg_3' => 'nullable',
            'barber-shop_white' => 'nullable',
            'barber-shop_white_rgb' => 'nullable',
            'barber-shop_black' => 'nullable',
            'barber-shop_black_rgb'=> 'nullable|string|max:191',
            'barber-shop_border_color'=> 'nullable|string|max:191',
            'barber-shop_border_color_two'=> 'nullable|string|max:191',
            'barber-shop_success_color'=> 'nullable|string|max:191',
            'barber-shop_delete_color'=> 'nullable|string|max:191',
            'barber-shop_heading_color'=> 'nullable|string|max:191',
            'barber-shop_body_color'=> 'nullable|string|max:191',
            'barber-shop_paragraph_color'=> 'nullable|string|max:191',
            'barber-shop_paragraph_color_two'=> 'nullable|string|max:191',
            'barber-shop_light_color'=> 'nullable|string|max:191',
            'barber-shop_review_color'=> 'nullable|string|max:191',
        ];
