...
trait PaymentLogIpn
{
    ...
    public function paymob_ipn()
    {
        $kinetic_ipn = PaymentGatewayCredential::get_paymob_credential();
    ...
    {
        $awdpay_ipn = PaymentGatewayCredential::get_awdpay_credential();

        try{
            $payment_data = $awdpay_ipn->ipn_response();
    ...
    {
        $iyzipay_ipn = PaymentGatewayCredential::get_iyzipay_credential();
