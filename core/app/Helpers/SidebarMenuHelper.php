...
class SidebarMenuHelper
{
    ...
    private function payment_gateway_manage_menus(MenuWithPermission $menu_instance) : void
    {
        ...
        $menu_instance->add_menu_item('paymob-settings-list-menu-items', [
            'route' => 'landlord.admin.payment.paymob.settings',
            'label' => __('paymob'),
            'parent' => 'payment_gateway-manage-settings-menu-items',
            'permissions' => [],
        ]);
        $menu_instance->add_menu_item('awdpay-settings-list-menu-items', [
            'route' => 'landlord.admin.payment.awdpay.settings',
            'label' => __('awdpay'),
            'parent' => 'payment_gateway-manage-settings-menu-items',
            'permissions' => [],
        ]);
        $menu_instance->add_menu_item('powertranzpay-settings-list-menu-items', [
            'route' => 'landlord.admin.payment.powertranzpay.settings',
        ...
        foreach (getAllExternalPaymentGatewayMenu() as $externalMenu) {
            foreach ($externalMenu as $individual_menu_item) {
                $convert_to_array = (array)$individual_menu_item;
                $convert_to_array['parent'] = 'payment_gateway-manage-settings-menu-items';
    ...
    public function tenant_donation_activities(MenuWithPermission $menu_instance): void
    {
        $menu_instance->add_menu_item('donation-activities-settings-menu-items', [
            ...
            'parent' => null,
            'permissions' => ['donation-activities-list','donation-activities-create','donation-activities-edit','donation-activities-delete'],
            'icon' => 'mdi mdi-cash-multiple',
        ]);
        ...
        $menu_instance->add_menu_item('settings-donation-activity-list', [
            ...
            'permissions' => ['donation-activities-list'],
        ]);
        ...
        $menu_instance->add_menu_item('donation-activity-add', [
            ...
            'parent' => 'donation-activities-settings-menu-items',
            'permissions' => ['donation-activities-create'],
        ]);
    ...
    public function tenant_knowledgebase_settings_menu(MenuWithPermission $menu_instance): void
    {
        ...
        $menu_instance->add_menu_item('settings-knowledgebase-category', [
            ...
            'label' => __('Category'),
            'parent' => 'knowledgebase-settings-menu-items',
            'permissions' => ['knowledgebase-category-list','knowledgebase-category-create','knowledgebase-category-edit','knowledgebase-category-delete'],
        ]);
    }
...
//        ]);
    ...
    private function tenant_payment_gateway_manage_menus(MenuWithPermission $menu_instance) : void
    {
        ...
        if (in_array('paymob',$check_all_feature)) {
            $menu_instance->add_menu_item('paymob-settings-list-menu-items', [
        ...
        if (in_array('powertranzpay',$check_all_feature)) {
            $menu_instance->add_menu_item('powertranzpay-settings-list-menu-items', [
        ...
        if (in_array('awdpay',$check_all_feature)) {
            $menu_instance->add_menu_item('awdpay-settings-list-menu-items', [
