...
return [
    ...
    'database' => [
         ...
         */
        'prefix' =>'multipurposesass_tenant_',
        'suffix' => '',
    ...
    'migration_parameters' => [
        ...
        '--path' => [
            ...
            tenant_module_migrations_file_path("Donation"),
            tenant_module_migrations_file_path("Event"),
            tenant_module_migrations_file_path("Job"),
            tenant_module_migrations_file_path("Knowledgebase"),
            ...
            tenant_module_migrations_file_path("CouponManage"),
            tenant_module_migrations_file_path("Inventory"),
            tenant_module_migrations_file_path("ShippingModule"),
            tenant_module_migrations_file_path("CountryManage"),
