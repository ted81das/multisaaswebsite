...
use Modules\Restaurant\Database\Seeders\RestaurantCurrentHomeSeeder;
use Modules\Restaurant\Database\Seeders\RestaurantDatabaseSeeder;
use Modules\Restaurant\Database\Seeders\RestaurantLayoutSeeder;
use Modules\Restaurant\Database\Seeders\RestaurantRolePermissionSeed;
...
class TenantDatabaseSeeder extends Seeder
{
    public function run()
    {
        ...
        if(moduleExists('HotelBooking')){
            if (in_array('hotelbooking',$check_feature_name) || in_array('hotel_booking',$check_feature_name)) {
                HotelBookingRolePermissionSeed::run();
                CurrentHomeSeed::run();
        ...
        if(moduleExists('Restaurant')){
            if (in_array('restaurant',$check_feature_name)) {
                RestaurantCurrentHomeSeeder::run();
                RestaurantLayoutSeeder::run();
                RestaurantRolePermissionSeed::run();
            }
        }
