<div class="col-xl-7 col-lg-7 mt-4">
    <div class="checkout-wrapper">
        @if(!Auth::guard('web')->check())
            @include('product::frontend.shop.checkout.partials.sign_in')
        @endif
            ...
            <div class="checkout-inner-contents">
                <div class="checkout-form-wrapper mt-2">
                    <form action="{{route('tenant.shop.checkout')}}" method="POST" class="checkout-form" enctype="multipart/form-data">
                        ...
                        <input type="hidden" name="kineticpay_bank" class="payment_gateway_passing_clicking_name" >
                        <input type="hidden" name="transaction_id" class="form-control transaction_id" value="">
                        ...
                        <input type="hidden"  name="manual_payment_attachment" id="manual_payment_attachment" class="manual_payment_attachment2">
                        <div class="manual_payment_attachment_div">
                        ...
                        <div class="checkout-form-flex">
                            <div class="single-input mt-4">
                                ...
                                <input class="form--control" type="text" name="name" placeholder="{{__('Type First Name')}}" value="{{$billing_info ? $billing_info->full_name : ''}}" {{$readonly}}>
                            </div>
                        </div>
                        <div class="checkout-form-flex">
                            <div class="single-input mt-4">
                                <label class="label-title mb-3"> {{__('Mobile Number')}} </label>
                                <input class="form--control" type="tel" placeholder="{{__('Type Mobile Number')}}" name="phone" value="{{$billing_info ? $billing_info->phone : ''}}" {{$readonly}}>
                            </div>
                            <div class="single-input mt-4">
                                <label class="label-title mb-3"> {{__('Email Address')}} </label>
                                <input class="form--control" type="text" placeholder="{{__('Type Email')}}" name="email" value="{{$billing_info ? $billing_info->email : ''}}" {{$readonly}}>
                            </div>
                        </div>
                        <div class="checkout-form-flex">
                            <div class="single-input mt-4">
                            ...
                            <div class="single-input mt-4">
                                ...
                                <select class="form--control billing_address_state form-control" name="state" id="state">
                                    @if($billing_info != null)
                            ...
                            <div class="single-input mt-4">
                                ...
                                <input class="form--control" type="text" placeholder="{{__('Type City/Town')}}" name="city" value="{{$billing_info ? $billing_info->city : ''}}" {{$readonly}}>
                            </div>
                            <div class="single-input mt-4">
                                <label class="label-title mb-3"> {{__('Zip Code')}} </label>
                                <input class="form--control" type="text" placeholder="{{__('Type Zip Code')}}" name="zipcode" value="{{$billing_info ? $billing_info->zipcode : ''}}" {{$readonly}}>
                            </div>
                        </div>
                        <div class="checkout-form-flex">
                            <div class="single-input mt-4">
                                <label class="label-title mb-3"> {{__('Address')}} </label>
                                <textarea class="form--control form--message" name="address" placeholder="{{__('Type Address')}}" {{$readonly}}>{{$billing_info ? $billing_info->address : ''}}</textarea>
                            </div>
                        </div>
                        ...
                        @if(!Auth::guard('web')->check())
                            <div class="create-account-wrapper mt-4 mt-lg-5 ">
                                ...
                                <div class="checkout-form-open-register">
                                    <div class="checkout-form-flex">
                                        <div class="single-input mt-4">
                        ...
                        @if($billing_info != null)
                            @include('product::frontend.shop.checkout.partials.shift_another_address')
                        @endif

                        <div class="checkout-form-flex">
                            <div class="single-input mt-4">
                                <label class="label-title mb-3"> {{__('Order Notes')}} </label>
                                <textarea class="form--control form--message" name="message" placeholder="{{__('Type Messages')}}"></textarea>
                            </div>
                        </div>
                    </form>
                </div>
