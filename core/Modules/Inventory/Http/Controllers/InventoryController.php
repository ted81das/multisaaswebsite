...
class InventoryController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->middleware('permission:inventory-list|inventory-create|inventory-edit|inventory-delete', ['only', ['index']]);
        $this->middleware('permission:inventory-create', ['only', ['create', 'store']]);
        $this->middleware('permission:inventory-edit', ['only', ['edit', 'update']]);
        $this->middleware('permission:inventory-delete', ['only', ['destroy', 'bulk_action']]);
    }
