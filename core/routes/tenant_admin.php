...
-------------------------------------------- */
    Route::controller(\App\Http\Controllers\Landlord\Admin\PaymentSettingsController::class)->prefix('payment-settings')->group(function (){
        ...
        Route::get('/paymob','paymob_settings')->name('admin.payment.paymob.settings');
        Route::get('/awdpay','awdpay_settings')->name('admin.payment.awdpay.settings');
        Route::get('/powertranzpay','powertranzpay_settings')->name('admin.payment.powertranzpay.settings');
