...
class TenantServiceCategoryWithSearchWidget extends WidgetBase
{
    ...
    public function frontend_render()
    {
        ...
        foreach ($blog_categories as $item){
            ...
            $form_action = route('tenant.frontend.service.search');
            $url = route('tenant.frontend.service.category', ['id' => $item->id, 'any' => Str::slug(!empty($title) ? $title : get_default_language())]);
...
HTML;
    ...
    {
        return __('Service Category & Search');
    }
}
