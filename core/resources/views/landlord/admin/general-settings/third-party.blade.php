                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{route(route_prefix().'admin.general.third.party.script.settings')}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label for="site_google_captcha_v3_site_key">{{__('Google Captcha V2 Site Key for User Register')}}</label>
                                <input type="text" name="site_google_captcha_v2_site_key"  class="form-control" value="{{get_static_option('site_google_captcha_v2_site_key')}}" id="site_google_captcha_v3_site_key">
                            </div>
                            <div class="form-group">
                                <label for="site_google_captcha_v3_secret_key">{{__('Google Captcha V2 Secret Key for User Register')}}</label>
                                <input type="text" name="site_google_captcha_v2_secret_key"  class="form-control" value="{{get_static_option('site_google_captcha_v2_secret_key')}}" id="site_google_captcha_v3_secret_key">
                            </div>
