...
@if(!empty(tenant()->id) && file_exists('assets/tenant/frontend/themes/js/dynamic-scripts/'.tenant()->id.'-script.js') && !is_dir('assets/tenant/frontend/themes/js/dynamic-scripts/'.tenant()->id.'-script.js'))
