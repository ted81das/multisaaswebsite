...
@section('style')
    ...
    <style>
        ...
        .listItem .btn-wrapper a.cmn-btn4 {
        ...
        .listItem .btn-wrapper a.cmn-btn4:hover {
                ...
                <div class="ourReview">
                    <div class="nav-button mb-30">
                        ...
                        <nav>
                            <div class="nav nav-tabs " id="nav-tab" role="tablist">
                                ...
                                <a class="nav-link" id="nav-four-tab" data-bs-toggle="tab" href="#nav-four" role="tab" aria-controls="nav-four" aria-selected="false">{{__('Summary')}}</a>
                    ...
                    <div class="tab-content" id="nav-tabContent">
                        ...
                        <div class="tab-pane fade" id="nav-four" role="tabpanel" aria-labelledby="nav-four-tab">
                            ...
                            <div class="capDescription">
                                <div class="single mb-24">
                                    @include('product::frontend.shop.product_details.partials.product-summary')
                                </div>
                            </div>
                        </div>
